...
namespace Steam_TripleBrain.Migrations
{
    ...
    [Migration("20260526145425_AddIsDLCAndParentGameId")]
    partial class AddIsDLCAndParentGameId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Steam_TripleBrain.Profiles.Tokens.TokenJournal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Steam_TripleBrain.Profiles.Tokens.TokenJournal", b =>
                {
                    b.HasOne("Steam_TripleBrain.Models.JwtToken", "Token")
                        .WithMany("TokenJournals")
                        .HasForeignKey("TokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Steam_TripleBrain.Models.User", "User")
                        .WithMany("TokenJournals")
                        .HasForeignKey("UserId");
